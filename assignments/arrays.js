...
console.log(`Car 33 is a ${inventory[id = 33].car_year} ${inventory[id = 33].car_make} ${inventory[id = 33].car_model} `);
...
for (let l = 0; l < carYears.length; l++) {

    if (carYears[l] < 2000) {
        oldCars.push(carYears[l]);
    }
...
for (let b = 0; b < inventory.length; b++) {
    ...
    if(inventory[b].car_make === "BMW" || inventory[b].car_make === "Audi"){
